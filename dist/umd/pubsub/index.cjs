...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@sbp/okturtles.events", "@sbp/sbp"], factory);
    }
        ...
        for (const name of Object.keys(defaultClientEventHandlers)) {
            client.listeners[name] = (event) => {
                ...
                try {
                    ...
                    (0, sbp_1.default)('okTurtles.events/emit', exports.PUBSUB_ERROR, client, error === null || error === void 0 ? void 0 : error.message);
                }
            };
        }
    ...
    const defaultClientEventHandlers = {
        ...
        open() {
            ...
            client.pendingSubscriptionSet.forEach((channelID) => {
                var _a;
                (_a = client.socket) === null || _a === void 0 ? void 0 : _a.send(createRequest(exports.REQUEST_TYPE.SUB, { channelID }));
            });
    ...
    const defaultMessageHandlers = {
        ...
        [exports.NOTIFICATION_TYPE.PING]({ data }) {
            ...
            (_a = client.socket) === null || _a === void 0 ? void 0 : _a.send(createMessage(exports.NOTIFICATION_TYPE.PONG, data));
        ...
        sub(channelID) {
            ...
            if (!client.pendingSubscriptionSet.has(channelID)) {
                ...
                if ((socket === null || socket === void 0 ? void 0 : socket.readyState) === WebSocket.OPEN) {
                    socket.send(createRequest(exports.REQUEST_TYPE.SUB, { channelID }));
                }
            }
        },
        /**
