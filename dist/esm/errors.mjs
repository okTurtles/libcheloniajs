...
export const ChelErrorKeyWrapCycle = ChelErrorGenerator('ChelErrorKeyWrapCycle', ChelErrorKeySpecInvalid);
...
export const ChelErrorKeyNameNotFound = ChelErrorGenerator('ChelErrorKeyNameNotFound', ChelErrorKeySpecInvalid);
