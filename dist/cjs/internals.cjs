...
exports.clearReprocessDebounceAll = exports.clearReprocessDebounceForContract = void 0;
...
exports.default = (0, sbp_1.default)('sbp/selectors/register', {
    ...
    'chelonia/private/removeImmediately': function (contractID, params) {
        ...
        (0, reingestTracker_js_1.clearReingestTrackerForContract)(contractID);
                ...
                try {
                    if (r.status === 409) {
                        ...
                        if (!entry.isFirstMessage() && entry.height() === lastAttemptedHeight) {
                            await (0, sbp_1.default)('chelonia/private/in/sync', contractID, { force: true });
                        }
                    }
                    else {
                    ...
                    if (mustResync) {
                        ...
                        if (self.subscriptionSet.has(v.contractID)) {
                            const resync = (0, sbp_1.default)('chelonia/private/queueEvent', v.contractID, [
                                ...
                                (0, sbp_1.default)('chelonia/private/in/sync', contractIdsToUpdate.filter((contractID) => {
...
const reprocessDebounced = (contractID) => {
    ...
    if (!d) {
        ...
        d = (0, turtledash_1.debounce)(() => {
            ...
            (0, sbp_1.default)('chelonia/private/in/sync', contractID, { force: true }).catch((e) => {
...
// re-seeded contract.
const clearReprocessDebounceForContract = (contractID) => {
...
exports.clearReprocessDebounceForContract = clearReprocessDebounceForContract;
const clearReprocessDebounceAll = () => {
    for (const d of reprocessDebounceMap.values())
        d.clear();
    reprocessDebounceMap.clear();
};
exports.clearReprocessDebounceAll = clearReprocessDebounceAll;
const handleEvent = {
    checkMessageOrdering(message) {
        ...
        if (latestProcessedHeight + 1 < height) {
            ...
            const note = (0, reingestTracker_js_1.noteFutureEvent)(contractID, hash, height);
            if (note === 'added') {
        ...
        if ((0, reingestTracker_js_1.noteReingestSuccess)(contractID, hash)) {
        ...
        (0, reingestTracker_js_1.pruneStaleEntries)(contractID, height);
    },
    ...
    async applyProcessResult({ message, state, contractState, processingErrored, processingError, postHandleEvent }) {
        ...
        // the way out.
        (0, sbp_1.default)('chelonia/private/journal/recordEvent', contractID, message, beforeContractState, processingErrored ? beforeContractState : contractState, processingErrored, processingError ?? null);
        if (!processingErrored) {
