...
class PersistentAction {
    ...
    async attempt() {
        ...
        try {
            ...
            const result = await (0, sbp_1.default)(...this.invocation);
    ...
    async handleError(error) {
        ...
        if (!anyAttemptLeft) {
            (0, sbp_1.default)('okTurtles.events/emit', events_js_1.PERSISTENT_ACTION_TOTAL_FAILURE, { error, id });
    ...
    handleSuccess(result) {
        ...
        status.nextRetry = '';
        status.resolved = true;
        (0, sbp_1.default)('okTurtles.events/emit', events_js_1.PERSISTENT_ACTION_SUCCESS, { id, result });
    }
    async trySBP(invocation) {
        try {
            return invocation ? await (0, sbp_1.default)(...invocation) : undefined;
        }
        catch (error) {
...
exports.PersistentAction = PersistentAction;
exports.default = (0, sbp_1.default)('sbp/selectors/register', {
    'chelonia.persistentActions/_init'() {
        ...
        (0, sbp_1.default)('okTurtles.events/on', events_js_1.PERSISTENT_ACTION_SUCCESS, ({ id }) => {
            (0, sbp_1.default)('chelonia.persistentActions/cancel', id);
        });
        (0, sbp_1.default)('okTurtles.events/on', events_js_1.PERSISTENT_ACTION_TOTAL_FAILURE, ({ id }) => {
            (0, sbp_1.default)('chelonia.persistentActions/cancel', id);
        });
    },
    ...
    async 'chelonia.persistentActions/cancel'(id) {
        if (id in this.actionsByID) {
            ...
            return await (0, sbp_1.default)('chelonia.persistentActions/save');
        }
    },
    // TODO: validation
    ...
    'chelonia.persistentActions/enqueue'(...args) {
        ...
        (0, sbp_1.default)('chelonia.persistentActions/save').catch((e) => {
    ...
    async 'chelonia.persistentActions/load'() {
        this.checkDatabaseKey();
        const storedActions = JSON.parse((await (0, sbp_1.default)('chelonia.db/get', this.databaseKey)) ?? '[]');
        ...
        return (0, sbp_1.default)('chelonia.persistentActions/retryAll');
    },
