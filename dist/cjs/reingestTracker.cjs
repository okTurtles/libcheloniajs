...
// shared.
exports.REINGEST_PER_CONTRACT_CAP = 20;
 ...
 */
const noteReingestSuccess = (contractID, hash) => {
...
exports.pendingReingestCount = pendingReingestCount;
/**
 ...
 */
const clearReingestTrackerForContract = (contractID) => {
    trackers.delete(contractID);
};
exports.clearReingestTrackerForContract = clearReingestTrackerForContract;
/**
 * Drop the entire tracker. Called from `chelonia/reset`.
 */
const clearReingestTrackerAll = () => {
    trackers.clear();
};
exports.clearReingestTrackerAll = clearReingestTrackerAll;
