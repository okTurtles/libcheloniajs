  ...
  'chelonia/kv/_loadSlotNow': function (
    ...
    return (async () => {
      ...
      try {
        ...
        setSlotStatus(
          this, rootState, contractID, slot.contractType, slot.key,
          KV_LOAD_STATUS.ERROR, lastError
        )
        throw e
      }
      if (parsed === null) {
        ...
        setSlotStatus(
          this, rootState, contractID, slot.contractType, slot.key, KV_LOAD_STATUS.NON_INIT
        )
      ...
      setSlotStatus(
        this, rootState, contractID, slot.contractType, slot.key,
        wasClear ? KV_LOAD_STATUS.NON_INIT : KV_LOAD_STATUS.LOADED
      )
        ...
        if (hasPendingConflict) {
          ...
          return sbp('chelonia/kv/_loadSlotNow', {
            ...
            if (currentBucket) {
              ...
              if (currentBucket.size === 0) this.kvLocalEchoCIDs.delete(echoKey)
            }
            return result
          })
        }
