...
export default sbp('sbp/selectors/register', {
  ...
  'chelonia/kv/queuedSet': ({ contractID, key, data, onconflict, ifMatch, encryptionKeyName = 'cek', signingKeyName = 'csk' }: { contractID: string, key: string, data: JSONType, onconflict?: ChelKvOnConflictCallback, ifMatch?: string, encryptionKeyName: string, signingKeyName: string }) => {
